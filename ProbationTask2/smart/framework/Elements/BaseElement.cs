...
namespace demo.framework.Elements
{
    public abstract class BaseElement : BaseEntity
    {
        ...
        private WebDriverWait _wait = new WebDriverWait(Browser.GetDriver(), TimeSpan.FromSeconds(Convert.ToDouble(Configuration.GetTimeout())));
        ...
        public Boolean IsDisplayed()
        {
            ...
            Log.Info(GetName() + " : is displayed : " + isDisplayed);
            return isDisplayed;
        }
        ...
        protected void WaitUntilClickable()
        {
